...
namespace FlashShop.Infrastructure.Persistence.ReadServices;

public sealed class AdminDashboardReadService(AppDbContext dbContext) : IAdminDashboardReadService
{
    ...
    public async Task<AuditLogListDto> GetAuditLogsAsync(string? entityType, int page, int pageSize, CancellationToken cancellationToken)
    {
        ...
        return new AuditLogListDto(logs, totalCount, safePage, safePageSize);
    }
}
